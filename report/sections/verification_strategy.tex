...
Veil. In the current relational encoding, relatively little auxiliary Lean
infrastructure is needed, but the natural future obligations would include:
...
\item arithmetic lemmas needed for stronger conservation theorems.
\end{itemize}
